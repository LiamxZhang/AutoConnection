...
class NetworkService:
    ...
    def connect(self, credentials: Credentials) -> ConnectionResult:
        ...
        try:
            ...
            try:
                ...
                with response:
                    if not self._is_success_status(self._response_status(response)):
                        return ConnectionResult(ConnectionCode.PORTAL_UNREACHABLE, "Portal is unavailable.")
            except HTTPError as error:
                try:
                    return ConnectionResult(ConnectionCode.PORTAL_UNREACHABLE, "Portal is unavailable.")
                finally:
            ...
            try:
                ...
                with response:
                    ...
                    if status in {401, 403}:
                        return ConnectionResult(ConnectionCode.PORTAL_REJECTED, "Portal rejected the login.")
            ...
            return ConnectionResult(ConnectionCode.VERIFICATION_FAILED, "Connection could not be verified.")
        except Exception:
